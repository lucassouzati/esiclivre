...
<form action="<?php echo URL_BASE_SISTEMA;?>acompanhamento/cadastro.php" id="formulario" method="post">
...
<table align="center" cellpadding="0"  width="100%" cellspacing="1" class="tabDetalhe">
	...
	<tr id="lnDemanda1">
                ...
                <td align="left">
                    ...
                    <a href="<?php echo URL_BASE_SISTEMA;?>acompanhamento/cadastro.php?codigo=<?php echo $idsolicitacaoorigem?>">[Visualizar Processo Origem]</a>
                    <?php }?>
                </td>
                <td align="left">
                    <b>Situação</b> <br>
	...
	<tr>
		<td colspan="4">
                    <br>
                    <?php 
                    //se tiver resposta negada, e permitir recurso
                    if($situacao == "N" and $permiterecurso) 
                    { 
                        ?>
                    ...
                    <input type="button" value="Voltar" class="botaoformulario" name="voltar" onclick="location.href='<?php echo URL_BASE_SISTEMA;?>acompanhamento/index.php?<?php echo $parametrosIndex;?>'" />
		</td>
	</tr>
</table>
</form>
