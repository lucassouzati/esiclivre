			...
			<table align="left" width="100%" cellpadding="10" cellspacing="10">
                        <tr>
                                ...
                                <td align="left" valign="top">
                                        <input type="radio" name="tipopessoa" value="F" <?php echo ($tipopessoa=="F")?"checked":""; ?> onclick="selecionaTipoPessoa('F');">Física
                                        <input type="radio" name="tipopessoa" value="J" <?php echo ($tipopessoa=="J")?"checked":""; ?> onclick="selecionaTipoPessoa('J');">Jurídica
                                </td>
                        </tr>
			<tr>
			...
			<table width="100%">
				<tr>
					...
					<td align="left">
						...
						<a href="javascript:window.open('<?php echo URL_BASE_SISTEMA;?>inc/busca_cep_correios.htm','')"><img src="<?php echo URL_BASE_SISTEMA;?>img/busca_cep_correios.gif" border="0" align="absmiddle" style="margin:0px;padding:0px" title="Pesquisa CEP no site dos correios"></a>
					</td>
				</tr>
				<tr>
				...
				<script>
					InitQueryCode('cep', '<?php echo URL_BASE_SISTEMA;?>inc/lkpcep.php?q=');
