...
<table align="center" cellpadding="0"  width="100%" cellspacing="1" id="lista">
	...
	<tr id="ldadosDemanda">
		<td width="100%">
			...
			<tr id="lnProblema">
				<td align="left">Problema/Serviço:</td>
				<td align="left" width="100%">
			...
			<tr id="lnEnderecoOcorrencia">
				<td align="left"><b>Endereço da Ocorrência:</b></td>
				<td align="left">
			...
			<tr id="lnPontoReferencia">
				<td align="left">Ponto de referência</td>
				<td align="left">
	...
	<tr>
		<th align="left">INFORMAÇÕES EXTRAS</th>
	</tr>
        <tr id="lnObservacao">
		<td width="100%">
                    <table align="center" width="100%" cellpadding="0" cellspacing="1">
                        ...
                        <tr>
                                <td align="left" colspan="2"><input type="checkbox" name="publico" value="1" <?php ($publico)?"checked":"";?>> Demanda pode ser vista na WEB (pública)</td>
                        </tr>
                    </table>
                </td>
        </tr>
