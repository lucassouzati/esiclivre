...
?>
	...
	<script>
		$(document).ready(function ()
		{
			var bar = new RGraph.Bar({
				...
				data: [<?php echo $dados; ?>],
				options: {
					colors: ['Gradient(white:#006699:#006699)', 'Gradient(white:#FF9900:#FF9900)'],
					gutter: {
						top: 15,
						left: 50,
						right: 115
	...
	<br><br>
	<img width="20" height="20" style="background-color:#006699"> Pedidos Registrados
	<img width="20" height="20" style="background-color:#FF9900"> Pedidos Atendidos	
