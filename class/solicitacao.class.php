                ...
                if(!empty($email))
                {
                    ...
                    if($tipomsg == "N")
                    {
                        ...
                        $body="Prezado(a) $nome,<br> <br>
                                ...
                                <br><br>Para acompanhar o andamento, acesse o sistema ".SISTEMA_NOME." no endereço: ".URL_BASE_SISTEMA.".<br><br>
                                Mensagem Automática do Sistema ".SISTEMA_NOME;
                    }
                    //se for resposta
                    else if($tipomsg == "R")
                    {
                        ...
                        $body="Prezado(a) $nome,<br> <br>
                                Sua solicitação <b>$processo</b> foi respondida. Para mais informações acesse o sistema ".SISTEMA_NOME." no endereço: ".URL_BASE_SISTEMA.".<br><br>
                                Mensagem Automática do Sistema ".SISTEMA_NOME;
                    }
                    //se for prorrogada
                    else if($tipomsg == "P")
                    {
                        ...
                        $body="Prezado(a) $nome,<br> <br>
                                O atendimento a sua solicitação <b>$processo</b> foi prorrogado, data de previsão de resposta: $dataprevisaoresposta. Para mais informações acesse o sistema ".SISTEMA_NOME.".<br><br>
                                Mensagem Automática do Sistema ".SISTEMA_NOME;
                    }
