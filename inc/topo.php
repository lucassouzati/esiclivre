...
<html>
	<head>
		...
		<meta name="description" content="Portal da Prefeitura Municipal de Itaperuna - SMA - Secretaria Municipal de Administração" />
		<meta name="keywords" content="Prefeitura de Itaperuna, itaperuna, rj, sma, itaperuna, rj, noticias, serviços" />
		<meta name="robots" content="ALL" />
		<meta name="distribution" content="Global" />
		<meta name="rating" content="General" />
		<meta name="author" content="SMA, Prefeitura Municipal de Itaperuna" />
				...
				<div id="cabecalho">
					<div id="faixa">
						<ul>
							...
							<li class="opcao"><a target="_blank" href="http://itaperuna.rj.gov.br/">Principal</a></li>
							<img src="../css/img/pipe.png" />
							<li class="opcao"><a target="_blank" href="">Ouvidoria</a></li>
							<img src="../css/img/pipe.png" />
							<li class="opcao"><a target="_blank" href="http://itaperuna.rj.gov.br/">Secretarias e Órgãos</a></li>
							<img src="../css/img/pipe.png" />
							<li class="opcao"><a href="../faleconosco">Fale conosco</a></li>
							<img src="../css/img/pipe.png" />
							<li class="opcao"><a target="_blank" href="http://200.217.192.171/pronimtb/">Portal da Transparência</a></li>
						</ul>
					</div>
